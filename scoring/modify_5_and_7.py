...
# Example usage:
input_file_path = '/TaskExecutor/polyglot-ko-1.3b/grouped_results/before_sorting/ko_quiz_7_result.csv'
reference_file_path = '/TaskManager/ko_quiz/ko_quiz_7.csv'
output_file_path = '/TaskExecutor/polyglot-ko-1.3b/grouped_results/ko_quiz_7_result.csv'
