...
target = [
          ...
          '/TaskExecutor/llama2_13b/grouped_results/ko_quiz_4_result.csv',
          '/TaskExecutor/llama2_13b/grouped_results/ko_quiz_5_result.csv',
          '/TaskExecutor/llama2_13b/grouped_results/ko_quiz_6_result.csv',
          '/TaskExecutor/llama2_13b/grouped_results/ko_quiz_7_result.csv',
          '/TaskExecutor/llama2_13b/grouped_results/ko_quiz_8_result.csv',
          '/TaskExecutor/llama2_13b/grouped_results/nli_result.csv',
          '/TaskExecutor/llama2_13b/grouped_results/number_1_result.csv',
          '/TaskExecutor/llama2_13b/grouped_results/number_2_result.csv',
          '/TaskExecutor/llama2_13b/grouped_results/number_3_result.csv',
