...
target = [
        #   '/TaskExecutor/polyglot-ko-1.3b/grouped_results/ko_quiz_1_result.csv',
        #   '/TaskExecutor/polyglot-ko-1.3b/grouped_results/ko_quiz_2_result.csv',
        #   '/TaskExecutor/polyglot-ko-1.3b/grouped_results/ko_quiz_3_result.csv',
        #   '/TaskExecutor/polyglot-ko-1.3b/grouped_results/ko_quiz_4_result.csv',
          '/TaskExecutor/polyglot-ko-1.3b/grouped_results/ko_quiz_5_result.csv',
        #   '/TaskExecutor/polyglot-ko-1.3b/grouped_results/ko_quiz_6_result.csv',
          '/TaskExecutor/polyglot-ko-1.3b/grouped_results/ko_quiz_7_result.csv',
        #   '/TaskExecutor/polyglot-ko-1.3b/grouped_results/ko_quiz_8_result.csv',
        #   '/TaskExecutor/polyglot-ko-1.3b/grouped_results/nli_result.csv',
        #   '/TaskExecutor/polyglot-ko-1.3b/grouped_results/number_1_result.csv',
        #   '/TaskExecutor/polyglot-ko-1.3b/grouped_results/number_2_result.csv',
        #   '/TaskExecutor/polyglot-ko-1.3b/grouped_results/number_3_result.csv',
        #   '/TaskExecutor/polyglot-ko-1.3b/grouped_results/reasoning_result.csv',
        #   '/TaskExecutor/polyglot-ko-1.3b/grouped_results/spelling_correct_result.csv',
        #   '/TaskExecutor/polyglot-ko-1.3b/grouped_results/summarization_result.csv',
        #   '/TaskExecutor/polyglot-ko-1.3b/grouped_results/translation_result.csv',
          ]
